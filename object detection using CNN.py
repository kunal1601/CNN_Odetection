...
#The data is in integers therefore we will convert them to float first
...
#this time we set 30% of thitse nodes to 0 to minimize overfitting
...
print("Accuracy: &3.f%%" %(model.evaluate(X_test, y_test)[1]*100))
